...
const industriesItems = [
  "Fashion & Beauty", "Finance & Fintech",
  "Travel & Hospitality", "Automotive",
  "Gaming & Entertainment", "Retail & eCommerce",
];
      ...
      >
        ...
        <div className="hidden lg:flex items-center gap-0.5 xl:gap-1">
          ...
          <div className="relative" onMouseEnter={() => handleOpen("services")}>
            <button
              className={`cursor-pointer text-white text-sm font-medium px-3 py-1.5 rounded-full border transition-all ${
                openMenu === "services"
                  ? "border-white"
            ...
            {openMenu === "services" && (
              <div className="absolute top-full left-1/2 -translate-x-1/2 mt-3 w-[680px] bg-white rounded-2xl shadow-2xl flex overflow-hidden z-50">
                <div className="flex-1 p-8">
                  <p className="text-xs text-gray-400 font-medium uppercase tracking-widest mb-5">
                    Core Services
                  </p>
                ...
                <div className="w-[220px] relative flex-shrink-0">
                  ...
                  <Link
                    href="#"
                    className="absolute bottom-5 left-5 right-5 bg-black text-white text-xs font-semibold px-4 py-2.5 rounded-full flex items-center justify-between hover:bg-gray-800 transition-colors"
                  >
          ...
          <div className="relative" onMouseEnter={handleClose}>
            <Link
              href="#"
              className="cursor-pointer text-white text-sm font-medium px-3 py-1.5 rounded-full border border-transparent hover:border-white/30 transition-all flex items-center gap-1"
            >
              Work
          ...
          <div className="relative" onMouseEnter={() => handleOpen("blog")}>
            <button
              className={`cursor-pointer text-white text-sm font-medium px-3 py-1.5 rounded-full border transition-all whitespace-nowrap ${
                openMenu === "blog"
                  ? "border-white"
                  : "border-transparent hover:border-white/30"
              }`}
            ...
            {openMenu === "blog" && (
              <div className="absolute top-full right-0 mt-3 w-[420px] bg-white rounded-2xl shadow-2xl flex overflow-hidden z-50">
                <div className="flex-1 p-8 flex flex-col gap-5">
                  {blogItems.map((item) => (
                    <SlideLink
                      key={item}
        ...
        <motion.div
          className="group hidden lg:block cursor-pointer flex-shrink-0"
